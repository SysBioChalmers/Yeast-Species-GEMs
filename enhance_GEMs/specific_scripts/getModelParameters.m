...
%
%   Ivan Domenzain. Last edited: 2020-03-06
%
...
parameters.Ptot =param.Ptot;     %Assumed constant

%Minimum growth rate the model should grow at [1/h]
parameters.gR_exp = param.gR_exp;     %[g/gDw h] 

%Provide your organism scientific name
parameters.org_name = param.org_name;

%Provide your organism KEGG ID
parameters.keggID = param.keggID;
