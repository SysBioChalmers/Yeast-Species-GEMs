...
%Load species-specific parameters structure
load('parameters.mat');
%Total protein content in the cell [g protein/gDw]
parameters.Ptot =yeastParam.Ptot;     %Assumed constant
%Minimum growth rate the model should grow at [1/h]
parameters.gR_exp = yeastParam.gR_exp;     %[g/gDw h] 
%Provide your organism scientific name
parameters.org_name = yeastParam.org_name;
%Provide your organism KEGG ID
parameters.keggID = yeastParam.keggID;

%%%%% Parameters from  yeastGEM
