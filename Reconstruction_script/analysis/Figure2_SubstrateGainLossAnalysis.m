...
%% clade trait existence based on each clade and each trait- supplementary figure
clades = {'Ascomycota';'Lipomycetaceae';'Trigonopsidaceae';'Dipodascaceae/Trichomonascaceae';'Alloascoideaceae';'Sporopachydermia';'Pichiaceae';'CUG-Ala';'CUG-Ser1';'CUG-Ser2';'Phaffomycetaceae';'Saccharomycodaceae';'Saccharomycetaceae'};
clades(1) = [];
...
%% substrate usage in each clade/ metabolic innovation /loss
% BYCA definition
...
% substrate usage count in each clade
...
set(gca,'xticklabel',[])
camroll(-90)
 %% Figure for HGT/GD/Generalist in metabolic gain
 for i = 1:length(strains_sortclade)
