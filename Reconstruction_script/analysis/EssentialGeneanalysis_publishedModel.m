...
% Figure 3e essential gene prediction plot compared with published model
% prediction
% This function is to perform essential analysis and plot the figure

%%%%%%%%%%%%%%%%%%%%%%%
% inputpath = '../Reconstruction/modelRelated/ssGEMs';
% strains = {'Yarrowia_lipolytica','Schizosaccharomyces_pombe','Candida_albicans','Komagataella_pastoris','Saccharomyces_cerevisiae'}
% strains that contains the essential gene data
