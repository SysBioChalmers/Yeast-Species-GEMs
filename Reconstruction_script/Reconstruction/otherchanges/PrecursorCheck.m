function [missingMets, presentMets, solTotal, coupledMets, missingCofs, presentCofs] = PrecursorCheck(model, checkCoupling, checkConservedQuantities, ATN,mets)
% Checks if biomass precursors are able to be synthesized.
%
% USAGE:
%    [missingMets, presentMets, coupledMets, missingCofs, presentCofs] = PrecursorCheck(model, checkCoupling, checkConservedQuantities)
%
% INPUT:
...
solTotal = zeros(length(biomassMetabs),1); %set up the output for solution of all mets
